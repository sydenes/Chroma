...
namespace Chroma.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260719145644_AddSubscriptionPlans")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chroma.Domain.Entities.SubscriptionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chroma.Domain.Entities.TaskBoard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chroma.Domain.Entities.TaskCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "BoardId");

                    b.ToTable("task_cards", (string)null);
                });

            modelBuilder.Entity("Chroma.Domain.Entities.TaskCardLabel", b =>
                {
                    ...
                    b.ToTable("task_card_labels", (string)null);
                });

            modelBuilder.Entity("Chroma.Domain.Entities.TaskColumn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chroma.Domain.Entities.TaskComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chroma.Domain.Entities.TaskLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chroma.Domain.Entities.TenantSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chroma.Domain.Entities.TaskCard", b =>
                {
                    ...
                    b.HasOne("Chroma.Domain.Entities.TaskBoard", null)
                        .WithMany()
                        .HasForeignKey("BoardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chroma.Domain.Entities.TaskColumn", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Chroma.Domain.Entities.TaskCardLabel", b =>
                {
                    b.HasOne("Chroma.Domain.Entities.TaskCard", null)
                        .WithMany()
                        .HasForeignKey("CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chroma.Domain.Entities.TaskLabel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Chroma.Domain.Entities.TenantSubscription", b =>
                {
                    b.HasOne("Chroma.Domain.Entities.SubscriptionPlan", "Plan")
                        .WithMany()
